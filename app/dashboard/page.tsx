  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-[#101827] to-[#1c1607] text-white p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <a href="/register" className="block bg-amber-800 hover:bg-amber-700 text-white p-4 rounded-lg text-center">Create Account</a>
        <a href="/security" className="block bg-amber-800 hover:bg-amber-700 text-white p-4 rounded-lg text-center">Security Settings</a>
        <a href="/kyc" className="block bg-amber-800 hover:bg-amber-700 text-white p-4 rounded-lg text-center">KYC Liveness</a>
        <a href="/terms" className="block bg-amber-800 hover:bg-amber-700 text-white p-4 rounded-lg text-center">Terms of Service</a>
      </div>
