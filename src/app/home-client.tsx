...
// 1. Bendera ya Tanzania (Ukubwa Mdogo Zaidi: w-6 h-4)
const TanzaniaFlag = () => (
  <svg viewBox="0 0 900 600" className="w-6 h-4 rounded-sm border border-white/10 animate-flag-wave select-none">
    <rect width="900" height="600" fill="#1eb53a" />
    <path d="M0,600 L900,0 L900,600 Z" fill="#00a3dd" />
    <path d="M0,600 L900,0" stroke="#fcd116" strokeWidth="140" />
    <path d="M0,600 L900,0" stroke="#000000" strokeWidth="100" />
  </svg>
);

// 2. Bendera ya Uingereza / UK (Ukubwa Mdogo Zaidi: w-6 h-4)
const UkFlag = () => (
  <svg viewBox="0 0 60 30" className="w-6 h-4 rounded-sm border border-white/10 animate-flag-wave select-none">
    <clipPath id="s"><path d="M0,0 v30 h60 v-30 z"/></clipPath>
    <path d="M0,0 v30 h60 v-30 z" fill="#012169"/>
    <path d="M0,0 L60,30 M60,0 L0,30" stroke="#fff" strokeWidth="6" clipPath="url(#s)"/>
    <path d="M0,0 L60,30" stroke="#C8102E" strokeWidth="4" clipPath="url(#s)"/>
...
export default function HomeClient() {
  ...
  const copy = {
    ...
    nextStepText: isSw ? 'Sanidi pochi yako au badilisha mipangilio ya akaunti yako ili kuanza kutumia jukwaa letu.' : 'Configure your wallet ledger or edit your settings to start using our platform.',
    goWallet: isSw ? 'Fungua Pochi' : 'Open Wallet',
    openSettings: isSw ? 'Mipangilio' : 'Settings',
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-[#101827] to-[#1c1607] text-white">
      ...
      <section className="relative mx-auto max-w-7xl px-4 pb-16 pt-16 sm:px-6 sm:pt-24 lg:px-8">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-amber-300/20 bg-white/5 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-white global-glass">
          {copy.globalReach}
          <span className="h-1 w-1 rounded-full bg-amber-300" />
          {copy.globalReachText}
        </div>

           {/* Hero Typography - TOLEO LA BENDERA ZA RANGI (WINDOWS COMPATIBLE) */}
       <h1 className="mt-6 max-w-4xl text-4xl font-black leading-tight sm:text-5xl lg:text-6xl bg-gradient-to-r from-amber-100 via-white to-amber-200 bg-clip-text text-transparent drop-shadow-[0_0_24px_rgba(251,191,36,0.14)] flex items-center gap-3 flex-wrap">
            {copy.title}
           {isSw ? <TanzaniaFlag /> : <UkFlag />}
       </h1>
    <p className="mt-5 max-w-2xl text-base text-white/95 sm:text-lg">{copy.subtitle}</p>
        <div className="mt-12 rounded-3xl border border-white/10 bg-slate-900/40 p-6 backdrop-blur-xl shadow-2xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <Link href="/marketplace" className="group flex flex-col items-center justify-center rounded-2xl border border-amber-200/10 bg-slate-950/40 p-5 hover:border-amber-400/40 hover:bg-slate-950/70 transition duration-300 transform hover:-translate-y-1 shadow-lg">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 flex items-center justify-center text-slate-950 mb-3 group-hover:scale-110 transition shadow-lg">
                <ShoppingBag size={22} />
              </div>
            ...
            <Link href="/wallet" className="group flex flex-col items-center justify-center rounded-2xl border border-emerald-500/10 bg-slate-950/40 p-5 hover:border-emerald-400/40 hover:bg-slate-950/70 transition duration-300 transform hover:-translate-y-1 shadow-lg">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 flex items-center justify-center text-slate-950 mb-3 group-hover:scale-110 transition shadow-lg">
                <Wallet size={22} />
              </div>
            ...
            <Link href="/chat" className="group flex flex-col items-center justify-center rounded-2xl border border-blue-500/10 bg-slate-950/40 p-5 hover:border-blue-400/40 hover:bg-slate-950/70 transition duration-300 transform hover:-translate-y-1 shadow-lg">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center text-slate-950 mb-3 group-hover:scale-110 transition shadow-lg">
            ...
            <Link href="/exchange" className="group flex flex-col items-center justify-center rounded-2xl border border-violet-500/10 bg-slate-950/40 p-5 hover:border-violet-400/40 hover:bg-slate-950/70 transition duration-300 transform hover:-translate-y-1 shadow-lg">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-violet-500 to-purple-500 flex items-center justify-center text-white mb-3 group-hover:scale-110 transition shadow-lg">
                <RefreshCw size={22} />
              </div>
            ...
            <Link href="/admin/dashboard" className="group flex flex-col items-center justify-center rounded-2xl border border-pink-500/10 bg-slate-950/40 p-5 hover:border-pink-400/40 hover:bg-slate-950/70 transition duration-300 transform hover:-translate-y-1 shadow-lg">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-pink-500 to-rose-500 flex items-center justify-center text-slate-950 mb-3 group-hover:scale-110 transition shadow-lg">
                <User size={22} />
              </div>
            ...
            <Link href="/settings" className="group flex flex-col items-center justify-center rounded-2xl border border-slate-700/30 bg-slate-950/40 p-5 hover:border-slate-500/50 hover:bg-slate-950/70 transition duration-300 transform hover:-translate-y-1 shadow-lg">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-slate-600 to-gray-600 flex items-center justify-center text-white mb-3 group-hover:scale-110 transition shadow-lg">
                <Settings size={22} />
              </div>
          ...
          <div className="mb-4 flex flex-wrap items-center gap-2 text-xs">
            ...
            {enabledDisplayCurrencies.includes('tzs') && (
              <button
                ...
                className={`rounded-lg px-3 py-1 font-semibold transition ${displayCurrency === 'tzs' ? 'bg-amber-100 text-slate-900' : 'bg-slate-800/70 text-amber-50 hover:bg-slate-700'}`}
              >
                TZS
              </button>
            )}
