...
// Huu ndio mtaji wa GCV ya PI na USD
...
// Hii inatumika kama convertAmount
export function convertAmount(amount: number, from: string, to: string): number {
  return convertCurrency(amount, from, to);
}

export const PAYMENT_METHODS = ['usd', 'tzs', 'ntzs', 'pi'] as const;
