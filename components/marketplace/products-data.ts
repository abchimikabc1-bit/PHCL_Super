export const products = [
  ...
  // NYONGEZA MPYA: REAL ESTATE & AVIATION (VIWANJA NA USAFIRI WA ANGANI)
  { id: 96, name: 'Luxury Residential Plot (800sqm)', category: 'realestate', tzs: 42000000, usd: 16000, pi: 0.0509, rating: 4.9, reviews: 112, icon: '🗺️', location: 'Dar es Salaam', type: 'Plot' },
  { id: 97, name: 'Commercial Land Prime Location (2000sqm)', category: 'realestate', tzs: 157500000, usd: 60000, pi: 0.1911, rating: 5.0, reviews: 84, icon: '🏢', location: 'City Center', type: 'Commercial' },
  { id: 98, name: 'Private Jet Cessna Citation', category: 'aviation', tzs: 7875000000, usd: 3000000, pi: 9.5492, rating: 5.0, reviews: 45, icon: '✈️', condition: 'New', year: 2024, type: 'Aircraft' },
  { id: 99, name: 'Luxury Helicopter Bell 407', category: 'aviation', tzs: 3150000000, usd: 1200000, pi: 3.8196, rating: 4.9, reviews: 62, icon: '🚁', condition: 'New', year: 2024, type: 'Helicopter' },
  { id: 100, name: 'Yacht Azimut 55ft', category: 'marine', tzs: 2625000000, usd: 1000000, pi: 3.1831, rating: 4.9, reviews: 53, icon: '🛥️', condition: 'New', year: 2024, type: 'Boat' }
];