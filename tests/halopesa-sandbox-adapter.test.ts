...
type AdapterModule =
  typeof import(
    '@/lib/server-payment-provider-adapters/halopesa-sandbox'
  );

const CALLBACK_SECRET =
  'phcl-halopesa-sandbox-callback-secret-for-tests-only';
...
const originalCallbackSecret =
  process.env
    .HALOPESA_SANDBOX_CALLBACK_SECRET;

const originalCallbackMaxAge =
  process.env
    .HALOPESA_SANDBOX_CALLBACK_MAX_AGE_SECONDS;
...
function createDepositInput(
  ...
  return {
    requestId:
      'halopesa-deposit-request-001',

    operationId:
      'halopesa-deposit-operation-001',
...
describe(
  ...
  () => {
    ...
    test(
      'initiates an HaloPesa sandbox deposit without settling funds',
      async () => {
        const result =
          await adapter
            .initiateDeposit(
      ...
      async () => {
        const request =
          createSignedCallback({
            ...
            providerEventId:
              'halopesa-provider-event-001',

            providerTransactionId:
              'halopesa-provider-transaction-001',
    ...
    test(
      ...
      async () => {
        const request =
          createSignedCallback({
            requestId:
              'halopesa-deposit-request-002',

            providerEventId:
              'halopesa-provider-event-002',
    ...
    test(
      ...
      async () => {
        const request =
          createSignedCallback({
            requestId:
              'halopesa-deposit-request-003',

            providerEventId:
              'halopesa-provider-event-003',
      ...
      async () => {
        const request =
          createSignedCallback(
            {
              requestId:
                'halopesa-deposit-request-004',

              providerEventId:
                'halopesa-provider-event-004',
    ...
    test(
      ...
      async () => {
        const request =
          createSignedCallback({
            requestId:
              'halopesa-deposit-request-005',

            providerEventId:
              'halopesa-provider-event-005',
      ...
      async () => {
        ...
        const request =
          createSignedCallback(
            {
              requestId:
                'halopesa-deposit-request-006',

              providerEventId:
                'halopesa-provider-event-006',
    ...
    test(
      ...
      async () => {
        ...
        const request =
          createSignedCallback({
            requestId:
              'halopesa-deposit-request-007',

            providerEventId:
              'halopesa-provider-event-007',
    ...
    test(
      ...
      async () => {
        ...
        const request =
          createSignedCallback({
            requestId:
              'halopesa-deposit-request-008',

            providerEventId:
              'halopesa-provider-event-008',
